  ...
  <section>
    ...
    <div class="grid">
      <div class="package">
        ...
        <p>Ένα avatar σε απλό περιβάλλον (30 δευτ. διαφήμιση).</p>
      </div>
      <div class="package">
        <h3>Pro Ad – 499€</h3>
        <p>Προσαρμοσμένο avatar + περιβάλλον (50 δευτ., 1 διόρθωση).</p>
      </div>
      <div class="package">
        <h3>Premium Ad – 999€</h3>
        <p>Πολλαπλά avatars, κινηματογραφικές σκηνές, προηγμένη προσωποποίηση (μέχρι 2 λεπτά).</p>
      </div>
    </div>
  </section>
